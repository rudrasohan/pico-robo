...
class TestSO3(absltest.TestCase):
    ...
    def test_so3_valid_input(self):
        ...
        self.assertTrue(torch.allclose(so3_instance.value.squeeze(), valid_so3), "SO3 instance not correctly formed with valid input")
...
class TestSE3(absltest.TestCase):
    ...
    def test_se3_valid_input(self):
        ...
        self.assertTrue(torch.allclose(se3_instance.value.squeeze(), valid_se3), "SE3 instance not correctly formed with valid input")
    ...
    def test_se3_return_rt(self):
        ...
        self.assertTrue(torch.allclose(R, torch.eye(3)), "Rotation part incorrect")
        self.assertTrue(torch.allclose(T, torch.zeros(3)), "Translation part incorrect")
